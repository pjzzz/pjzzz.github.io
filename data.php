<?php
        ...
        {     
            ...
            {
                $query = "SELECT Product_id,Product_name,Units,Picture,Category_name,restaurant_name,Price,Product_description FROM PRODUCT,CATEGORY,restaurant WHERE PRODUCT.Category_id = CATEGORY.Category_id AND PRODUCT.restaurant_id = restaurant.restaurant_id AND (Product_name LIKE '%".$_POST['pattern']."%' OR restaurant_name LIKE '%".$_POST['pattern']."%' OR Category_name LIKE '%".$_POST['pattern']."%') ORDER BY CATEGORY.Category_id,restaurant.restaurant_id";
                $out = mysqli_query($conn,$query);
                $st1="display:inline-block;vertical-align:top;";
                $st4="height:350px; ";
                $st2="display:inline-block; float:middle;";
                $st3="background:#333333";
                $st5="background:#333333;align: bottom;";
                if(!($out))
                ...
                else
                {
                    ...
                    {
                        echo "
                                    <div class='panel panel-primary col-md-3 col-xs-6' style=".$st4.">
                                        <div class='panel-heading' style=".$st3.">
                                            <h3 class='panel-title'>".$row['Product_name']." <!--<span class='badge'>Units Available:".$row['Units']."</span>--></h3>
                                        </div>
                                        <div class='panel-body'>
                                    <div style=".$st1."><img height = 150 src = 'images/".$row['Picture']."'></div>
                                    <div style=".$st2.">
                                    ...
                                    <br><button class = 'btn btn-primary' style=".$st5." onclick='addSuccess(\"".$row['Product_name']."\",".$row['Product_id'].")'>Add to cart</button>
                                        </div>
                                    </div>
                        ";
                    }
            ...
            {
                $username = $_SESSION['username'];
                $query = "SELECT PRODUCT.Product_id, Product_name, Quantity, restaurant_name,Picture,Price,Product_description FROM CART, PRODUCT, restaurant WHERE CART.Product_id = PRODUCT.Product_id AND PRODUCT.restaurant_id = restaurant.restaurant_id AND user_id = '$username' ORDER BY Product_name;";
                $out = mysqli_query($conn,$query);
                            ...
                            <tr id='tr".$row['Product_id']."'>
                                <td data-th='Product'>
                                    <div class='row'>
                                        ...
                                        <div class='col-sm-10'>
                                            <h4 class='nomargin'>".$row['Product_name']." (".$row['restaurant_name'].")</h4>
                ...
                else
                {
                    ...
                    while($row = mysqli_fetch_array($out))
                    {
                        ...
                        echo "  <table id='cart' class='table table-hover table-condensed'>
                                ...
                                <tbody id='items'>";
                        $query = "SELECT * FROM PRODUCT JOIN PRODUCT_ORDER ON PRODUCT.Product_id = PRODUCT_ORDER.Product_id JOIN restaurant ON restaurant.restaurant_id = PRODUCT.restaurant_id WHERE PRODUCT_ORDER.Order_id = ".$row['Order_id'].";";
                                ...
                                <tr id='tr".$row2['Product_id']."'>
                                    <td data-th='Product' >
                                        <div class='row'>
                                            ...
                                            <div class='col-sm-10'>
                                                <h4 class='nomargin'>".$row2['Product_name']." (".$row2['restaurant_Name'].")</h4>
